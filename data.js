...
const CIGARETTES = [
  // ===== 일반 =====
  // 말보로 (PM)
  { name: "말보로 레드", type: "regular", tar: "8.0mg", color: "#c0392b", review: "묵직하고 진한 클래식, 골초들의 변함없는 스테디셀러" },
  { name: "말보로 골드", type: "regular", tar: "6.0mg", color: "#d4a017", review: "레드보다 부드럽지만 존재감은 확실한 무난한 선택" },
  { name: "말보로 실버", type: "regular", tar: "3.0mg", color: "#95a5a6", review: "말보로 감성 그대로 순하게, 라이트 유저 추천" },
  // 팔리아멘트 (PM)
  { name: "팔리아멘트 아쿠아 5", type: "regular", tar: "5.0mg", color: "#2471a3", review: "특유의 리세스 필터로 깔끔한 끝맛이 매력" },
  ...
  // 던힐 (BAT)
  { name: "던힐 6mg", type: "regular", tar: "6.0mg", color: "#5d1f1f", review: "깔끔하고 균형 잡힌 맛, 호불호 없이 무난하다는 평" },
  ...
  // 메비우스 (JTI)
  { name: "메비우스 오리지널", type: "regular", tar: "6.0mg", color: "#1a3c8f", review: "구관이 명관, 옛 마일드세븐 감성 그대로라는 평" },
  { name: "메비우스 스카이블루", type: "regular", tar: "3.0mg", color: "#5dade2", review: "가볍고 산뜻해서 데일리로 부담 없다는 후기 다수" },
  ...
  // 에쎄 (KT&G)
  { name: "에쎄 수 0.5", type: "regular", tar: "0.5mg", color: "#7d8a5c", review: "초저타르인데도 맛이 비지 않다는 국민 슬림 담배" },
  { name: "에쎄 수 0.1", type: "regular", tar: "0.1mg", color: "#a9b388", review: "국내 최저 수준 타르, 흡연량 줄이기용으로 인기" },
  { name: "에쎄 프라임", type: "regular", tar: "0.45mg", color: "#8a7040", review: "슬림 특유의 고소함, 순한 맛 찾는 분들의 정착지" },
  ...
  // 타임 (KT&G)
  { name: "타임 미드", type: "regular", tar: "4.5mg", color: "#d35400", review: "가성비 좋고 거친 듯 구수한 맛이 매력이라는 후기" },
  // 디스 (KT&G)
  { name: "디스", type: "regular", tar: "6.0mg", color: "#34495e", review: "IMF 시절부터 함께한 국민 가성비 담배" },
  { name: "디스 플러스", type: "regular", tar: "6.5mg", color: "#2c3e50", review: "디스보다 길어진 라지 사이즈, 오래 태우기 좋다는 평" },
  // 심플 (KT&G)
  { name: "심플 3mg", type: "regular", tar: "3.0mg", color: "#7f8c8d", review: "이름처럼 심플하고 깔끔한 맛, 꾸준한 수요" },
  // 기타 KT&G
  { name: "한라산", type: "regular", tar: "8.0mg", color: "#1e8449", review: "제주 감성의 진한 맛, 아는 사람만 찾는 롱셀러" },
  { name: "라일락", type: "regular", tar: "4.5mg", color: "#9b59b6", review: "은은한 꽃향 감성, 호불호 갈리지만 팬층 확고" },
  { name: "클라우드 나인", type: "regular", tar: "3.0mg", color: "#7f8fa6", review: "부드러운 연기와 은은한 향으로 조용한 마니아층 보유" },
  { name: "88 골드", type: "regular", tar: "6.5mg", color: "#b9770e", review: "88올림픽과 함께한 추억의 맛, 여전히 판매 중" },
  // 보헴 (KT&G)
  { name: "보헴 시가 미니", type: "regular", tar: "5.5mg", color: "#6e4a2f", review: "시가 특유의 달큰한 향, 색다른 맛 찾을 때 제격" },
  ...
  // ===== 캡슐 =====
  // 레종 (KT&G)
  { name: "레종 프렌치 블랙", type: "capsule", tar: "3.0mg", color: "#2c3e50", review: "커피 향 캡슐의 원조 강자, 달콤한 끝맛이 인기" },
  { name: "레종 블랙 아이스", type: "capsule", tar: "5.0mg", color: "#1b2631", review: "커피향에 쿨링까지, 아아 마시는 기분이라는 후기" },
  { name: "레종 휘바", type: "capsule", tar: "5.0mg", color: "#3498db", review: "터뜨리면 상큼함이 확 퍼진다는 호평의 스테디셀러" },
  ...
  // 에쎄 체인지 (KT&G)
  { name: "에쎄 체인지", type: "capsule", tar: "4.5mg", color: "#8e44ad", review: "일반↔맨솔 전환의 재미, 캡슐 입문용으로 추천 다수" },
  { name: "에쎄 체인지 빙", type: "capsule", tar: "4.5mg", color: "#5dade2", review: "얼음같은 쿨링 캡슐, 시원함 끝판왕이라는 후기" },
